...
- 🌍 **Поддержка нескольких языков**: Русский и английский (переведено нейронной сетью). Вы можете добавить свой перевод, поместив `.json` файл в папку `locales` – он автоматически появится в выпадающем списке языков.
